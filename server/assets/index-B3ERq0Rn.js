...
const Car = createLucideIcon("car", __iconNode$3);
const __iconNode$2 = [
  [
    "path",
    {
...
const Map$1 = createLucideIcon("map", __iconNode$2);
const __iconNode$1 = [
  [
    "path",
    {
...
const serviceTransfer = "/assets/service-transfer-B3SNrYmT.jpg";
const serviceSim = "/assets/service-sim-B-q06CP1.jpg";
...
const serviceTours = "/assets/service-tours-BXOBAPnX.jpg";
function HomePage() {
  const {
    t,
    locale
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative h-[80vh] min-h-[520px] overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heroPyramids, alt: "Pyramids", className: "absolute inset-0 w-full h-full object-cover", width: 1920, height: 1080 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 gradient-overlay" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-full max-w-7xl mx-auto px-4 sm:px-6 flex items-end pb-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
          opacity: 0,
          y: 30
        }, animate: {
          opacity: 1,
          ...
          duration: 0.8
        }, className: "max-w-3xl text-background", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block px-4 py-1.5 rounded-full bg-primary/20 backdrop-blur text-primary text-sm font-bold border border-primary/40 mb-5", children: "★ ON TIME 24/7" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-6xl lg:text-7xl font-black leading-tight mb-5 text-background", children: t.hero.welcome }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg md:text-xl text-background/85 mb-8 leading-relaxed max-w-2xl", children: t.hero.subtitle }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/transfers", className: "inline-flex items-center gap-2 px-7 py-3.5 rounded-xl gradient-hero text-primary-foreground font-bold shadow-gold hover:scale-[1.02] transition-transform", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Car, { className: "w-5 h-5" }),
              " ",
              t.hero.cta1
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/tours", className: "inline-flex items-center gap-2 px-7 py-3.5 rounded-xl bg-background/15 backdrop-blur text-background font-bold border border-background/30 hover:bg-background/25 transition-colors", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Map$1, { className: "w-5 h-5" }),
              " ",
              t.hero.cta2
            ] })
          ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative overflow-hidden bg-foreground text-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heroLimo, alt: "Limousine", loading: "lazy", className: "w-full h-72 md:h-[420px] object-cover", width: 1920, height: 1080 }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 md:p-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-5xl font-black mb-4 text-primary", children: t.hero.hero2Title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-background/80 leading-relaxed", children: t.hero.hero2Sub })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl font-black mb-3", children: t.services.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-1 bg-primary mx-auto rounded-full" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6", children: [{
          img: serviceTransfer,
          title: t.services.transferTitle,
          desc: t.services.transferDesc,
          cta: t.services.transferCta,
          to: "/transfers"
        }, {
          img: serviceTours,
          title: t.services.toursTitle,
          desc: t.services.toursDesc,
          cta: t.services.toursCta,
          to: "/tours"
        }, {
          img: serviceSim,
          title: t.services.simTitle,
          desc: t.services.simDesc,
          cta: t.services.simCta,
          to: "/sim-cards"
        }].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "group rounded-2xl overflow-hidden bg-card border border-border shadow-card hover:shadow-gold transition-all duration-300 hover:-translate-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-56 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: s.img, alt: s.title, loading: "lazy", className: "w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-black mb-2", children: s.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-5 leading-relaxed", children: s.desc }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: s.to, className: "inline-flex items-center gap-1.5 text-primary font-bold text-sm hover:gap-3 transition-all", children: [
              s.cta,
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: `w-4 h-4 ${locale === "en" ? "rotate-180" : ""}` })
            ] })
          ] })
        ] }, s.title)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-secondary/40 py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl font-black mb-3", children: t.tourTypes.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-1 bg-primary mx-auto rounded-full" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-5", children: tourCategories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/tours", search: {
          category: cat.key
        }, className: "group relative rounded-2xl overflow-hidden h-64 shadow-card hover:shadow-gold transition-all duration-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: cat.image, alt: locale === "ar" ? cat.ar : cat.en, loading: "lazy", className: "w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-foreground/90 via-foreground/30 to-transparent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 bottom-0 p-5 text-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-black", children: locale === "ar" ? cat.ar : cat.en }) })
        ] }, cat.key)) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl font-black mb-3", children: t.why.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-1 bg-primary mx-auto rounded-full" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-5", children: [{
          ...
          t: t.why.f4,
          d: t.why.f4d
        }].map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 rounded-2xl bg-card border border-border text-center hover:border-primary transition-colors", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-xl gradient-hero grid place-items-center text-primary-foreground mx-auto mb-4 shadow-gold", children: /* @__PURE__ */ jsxRuntimeExports.jsx(f.icon, { className: "w-7 h-7" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-black mb-1", children: f.t }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: f.d })
        ] }, f.t)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "max-w-7xl mx-auto px-4 sm:px-6 pb-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl gradient-dark p-10 md:p-16 text-center text-background relative overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 opacity-10", style: {
          backgroundImage: `url(${heroPyramids})`,
          backgroundSize: "cover",
          backgroundPosition: "center"
        } }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-5xl font-black mb-3 text-primary", children: t.cta.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-background/80 mb-7 max-w-xl mx-auto", children: t.cta.sub }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "inline-block px-8 py-3.5 rounded-xl gradient-hero text-primary-foreground font-bold shadow-gold hover:scale-105 transition-transform", children: t.cta.btn })
        ] })
      ] }) })
    ] }),
