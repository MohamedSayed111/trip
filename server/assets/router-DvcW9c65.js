...
function I18nProvider({ children }) {
  const [locale, setLocaleState] = reactExports.useState("ar");
  reactExports.useEffect(() => {
...
const appCss = "/assets/styles-euS_NbEY.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 text-xl font-semibold", children: "Page not found / الصفحة غير موجودة" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "The page you are looking for does not exist." }),
...
const Route$4 = createFileRoute("/tours")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Boat trips, safari, historical and shopping tours in Egypt."
    }]
  }),
  validateSearch: (s) => {
    const c = s.category;
    if (c === "boat" || c === "safari" || c === "historical" || c === "shopping") return {
      category: c
    };
    return {};
  },
...
const Route$3 = createFileRoute("/sim-cards")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Tourist SIM card plans for Egypt."
    }]
  }),
...
const Route$2 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Reach out to Luxor Taxis 24/7."
    }]
  }),
...
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "About Luxor Taxis Marsa Alam."
    }]
  }),
...
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Premium taxi transfers, Egypt tours and SIM cards in Marsa Alam."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const TransfersRoute = Route$5.update({
  id: "/transfers",
  path: "/transfers",
  getParentRoute: () => Route$6
});
const ToursRoute = Route$4.update({
  id: "/tours",
  path: "/tours",
  getParentRoute: () => Route$6
});
const SimCardsRoute = Route$3.update({
  id: "/sim-cards",
  path: "/sim-cards",
  getParentRoute: () => Route$6
});
